...
public abstract class Player {
	...
	public int ssDelay = -1, ssHeal = 0, soulSplitDamage = 0, leechEndGFX = 0;
	...
	public boolean inDuelArena() {
		...
		if((absX > 2944 && absX < 3274 && absY > 3904 && absY < 3965)) {
			return true;
		}
		return false;
	}
	...
	protected void appendPlayerAppearance(Stream str) {
		...
		synchronized(this) {
			...
			playerProps.writeByte(isPoisoned);			
